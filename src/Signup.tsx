            ...
            <div className='w-1/2 h-full bg-[#1a1a1a] flex flex-col p-20 justify-center'>
                <div className='w-full flex flex-col max-w-[450px] mx-auto'>
                    ...
                    <div className='w-full flex flex-col mb-10 text-white'>
                        <h3 className='text-4xl font-bold mb-2'>Đăng ký</h3>
                        <p className='text-lg mb-4'>Chào mừng! Vui lòng nhập thông tin của bạn bên dưới để bắt đầu.</p>
                    </div>
                ...
                <div className='w-full flex items-center justify-center mt-10'>
                    <p className='text-sm font-normal text-gray-400'>Bạn đã có tài khoản? <span className='font-semibold text-white cursor-pointer underline'><a href='/login'>Đăng nhập</a></span></p>
                </div>
            </div>
        </div>
    );
